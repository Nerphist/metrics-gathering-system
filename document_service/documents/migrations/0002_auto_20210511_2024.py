    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Gas', 'Gas'), ('Water', 'Water'), ('Electricity', 'Electricity'), ('Heat', 'Heat')], max_length=255)),
        ...
        migrations.AlterField(
            model_name='supplycontract',
            name='type',
            field=models.CharField(choices=[('Gas', 'Gas'), ('Water', 'Water'), ('Electricity', 'Electricity'), ('Heat', 'Heat')], max_length=255),
        ),
    ]
